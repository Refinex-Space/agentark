...
/**
 * 使用真实 Control Server 和临时 RSA JWT Decoder 启动浏览器 E2E，配置不进入生产 JAR。
 *
 * @author refinex
 */
public final class ControlE2eApplication {

    /**
     * 禁止实例化测试启动器。
     */
    private ControlE2eApplication() {
    }

    /**
     * 启动带 Test Classpath 安全配置的 Control Server。
     *
     * @param args Spring Boot 参数
     */
    public static void main(String[] args) {
        SpringApplication.from(AgentArkControlApplication::main)
            .with(E2eSecurityConfiguration.class)
            .run(args);
    }

    /**
     * 只从临时环境变量读取 RSA 公钥并保留 Issuer/Audience/时间校验。
     *
     * @author refinex
     */
    ...
    public static class E2eSecurityConfiguration {
        ...
        /**
         * 创建面向 Control Audience 的真实 RS256 Decoder。
         *
        ...
        public JwtDecoder e2eJwtDecoder() {
            return decoder("agentark-control");
        }
    }

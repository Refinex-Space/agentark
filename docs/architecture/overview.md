...
└── schemas/
    ...
    └── outbox-event/v1.json       # Phase 10 建立发布 Outbox 时创建
```
...
Phase 17 建立独立 Web Foundation，Phase 18 建立真实产品主链路；完整事实分布如下：

- [Web 信息架构](../frontend/information-architecture.md)：实际路由、分层、状态 Owner 和产品边界；
...
- Approval Center；
- Knowledge UI；
- Audit/Usage 关联入口；事实存储和检索由 Phase 19 交付。
